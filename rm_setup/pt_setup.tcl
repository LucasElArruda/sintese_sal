...
set NETLIST_FILES "../../../structural/dc/bcd.mapped.v"
...
set ACTIVITY_FILE ../../../../modeling/testbench/script/bcd.vcd
# strip_path setting for the activity file
set STRIP_PATH "sc_main/dut_rtl/rtl/bcd/uu_bcd"
...
set PARASITIC_FILES	 "../../../physical/dc/bcd.mapped.spef"
set PARASITIC_PATHS	 "" 

######################################
# Constraint Section Setup
######################################
set CONSTRAINT_FILES "../../../constraints/bcd.tcl"  
