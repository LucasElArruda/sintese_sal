...
#read_verilog -r ${RTL_SOURCE_FILES_V}
#read_vhdl -r ${RTL_SOURCE_FILES_VHD}
...
read_verilog -i ${RESULTS_DIR}/dc/${DESIGN_NAME}.mapped.eco.v
...
##NEW COMANDS######
load_upf -container -i ${DCRM_MV_UPF_INPUT_FILE} 
set_constant i:/WORK/bcd/i_static_shut_off 0 -type port
##NEW COMANDS######
